...
const SpeakerWave = (className: string): JSX.Element => (
	<svg
...
const SpeakerX = (className: string): JSX.Element => (
	<svg
		xmlns="http://www.w3.org/2000/svg"
		viewBox="0 0 24 24"
		fill="currentColor"
	...
	return (
		<Fragment>
			<div className="fixed flex justify-center top-0 right-0 w-full p-10">
				<div className="relative inline-flex flex-wrap justify-center items-stretch gap-4 mx-auto">
					...
					<MenuButton icon={state.muted ? SpeakerX : SpeakerWave} label="Audio" value="A" theme="blue" onClick={handleToggleMuted}/>
