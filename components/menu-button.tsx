...
const themeClasses: Record<Theme, ThemeConfig> = {
	blue: {
		enabled: 'border-sky-500 dark:border-sky-500 text-sky-700 dark:text-sky-400 bg-sky-100 dark:bg-sky-950 after:content-[""] after:absolute after:bottom-0 after:-mb-3 after:border-sky-500 dark:after:border-sky-500 after:w-1/3 after:border-b-4 after:rounded-full',
	...
	green: {
		enabled: 'border-green-500 dark:border-green-500 text-green-700 dark:text-green-400 bg-green-100 dark:bg-green-950 after:content-[""] after:absolute after:bottom-0 after:-mb-3 after:border-green-500 dark:after:border-green-500 after:w-1/3 after:border-b-4 after:rounded-full',
	...
	red: {
		enabled: 'border-red-500 dark:border-red-500 text-red-700 dark:text-red-400 bg-red-100 dark:bg-red-950 after:content-[""] after:absolute after:bottom-0 after:-mb-3 after:border-red-500 dark:after:border-red-500 after:w-1/3 after:border-b-4 after:rounded-full',
